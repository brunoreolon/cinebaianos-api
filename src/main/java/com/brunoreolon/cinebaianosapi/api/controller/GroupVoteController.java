...
public class GroupVoteController {
    ...
    @CheckGroupMember(service = GroupMemberService.class, allowBot = true)
    @GetMapping("/received")
    @Operation(summary = "Votos recebidos no grupo", description = "Retorna a lista de votos recebidos pelos membros do grupo, podendo filtrar por tipo de voto.")
    @ApiResponses({
    ...
    public ResponseEntity<List<UserVoteStatsResponse>> getVotesReceivedByGroup(
        ...
        List<UserVoteStatsResponse> votesReceived = userService.getVotesReceivedByGroup(groupId, voteType);
